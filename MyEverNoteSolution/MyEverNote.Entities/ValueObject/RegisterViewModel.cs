...
namespace MyEverNote.Entities.ValueObject
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("E-posta"), Required(ErrorMessage = "{0} alanı boş geçilemez."), StringLength(150, ErrorMessage = "{0} max. {1} karakter olmalı."),EmailAddress(ErrorMessage ="{0} geçerli bir email adresi giriniz.")]
